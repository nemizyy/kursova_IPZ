"""
observer.py — Патерн Observer (Спостерігач).

Бекенд виступає як Subject (видавець подій).
GUI (Flet) підписується як Observer і автоматично
отримує сповіщення при зміні даних.
